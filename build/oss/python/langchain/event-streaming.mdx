...
See [Custom projections](/oss/python/langgraph/streaming/custom-projections) for the transformer contract.

## Related

- [Pregel Streaming](/oss/python/langchain/streaming) covers low-level Pregel stream modes.
- [Custom projections](/oss/python/langgraph/streaming/custom-projections) covers application-specific projections.
