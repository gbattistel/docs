...
See [Custom transformers](/oss/python/langgraph/streaming/custom-transformers) for the transformer contract.

## Related

- [Pregel Streaming](/oss/python/langchain/streaming) covers low-level Pregel stream modes.
- [Custom transformers](/oss/python/langgraph/streaming/custom-transformers) covers application-specific projections.
