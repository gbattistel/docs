...
| Need | Read |
| ---- | ---- |
| Build application or frontend streaming experiences | [Event Streaming](/oss/python/langgraph/streaming/event-streaming) |
| Access LangGraph internals or advanced stream modes | [Pregel Streaming](/oss/python/langgraph/streaming) |
| Subscribe to specific graph, subgraph, or task events | [Namespaces](/oss/python/langgraph/streaming/namespaces) |
| Compare in-process and remote streaming | [Event Streaming](/oss/python/langgraph/streaming/event-streaming) |
| Add app-specific projections | [Custom transformers](/oss/python/langgraph/streaming/custom-transformers) |
| Create local or remote custom stream projections | [StreamChannel](/oss/python/langgraph/streaming/streamchannel) |
...
- Use [Event Streaming](/oss/python/langgraph/streaming/event-streaming) when you want projected events and typed stream accessors for application code.
- Use [Pregel Streaming](/oss/python/langgraph/streaming) when you want raw Pregel stream modes and are comfortable handling graph-runtime details directly.
...
- Remotely, the Python SDK streams deployed runs through `client.runs.stream(...)`.
