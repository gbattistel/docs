...
See [StreamChannel](/oss/python/langgraph/streaming/streamchannel) for choosing whether projection events should stay in process or also emit `custom:<name>` events.
