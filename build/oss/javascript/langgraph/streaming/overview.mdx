...
| Need | Read |
| ---- | ---- |
| Build application or frontend streaming experiences | [Event Streaming](/oss/javascript/langgraph/streaming/event-streaming) |
| Access LangGraph internals or advanced stream modes | [Pregel Streaming](/oss/javascript/langgraph/streaming) |
| Subscribe to specific graph, subgraph, or task events | [Namespaces](/oss/javascript/langgraph/streaming/namespaces) |
| Compare in-process and remote streaming | [Event Streaming](/oss/javascript/langgraph/streaming/event-streaming) |
| Understand the wire protocol | [Protocol](/oss/javascript/langgraph/streaming/protocol) |
| Add app-specific projections | [Custom transformers](/oss/javascript/langgraph/streaming/custom-transformers) |
| Create local or remote custom stream projections | [StreamChannel](/oss/javascript/langgraph/streaming/streamchannel) |
...
- Use [Event Streaming](/oss/javascript/langgraph/streaming/event-streaming) when you want projected events and typed stream accessors for application code.
- Use [Pregel Streaming](/oss/javascript/langgraph/streaming) when you want raw Pregel stream modes and are comfortable handling graph-runtime details directly.
...
- [LangChain agent streaming](/oss/javascript/langchain/streaming) covers ReAct-style agent messages, tool calls, and middleware updates.
