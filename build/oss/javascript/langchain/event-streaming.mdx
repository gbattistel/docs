...
See [Custom transformers](/oss/javascript/langgraph/streaming/custom-transformers) for the transformer contract.

## Related

- [Pregel Streaming](/oss/javascript/langchain/streaming) covers low-level Pregel stream modes.
- [Custom transformers](/oss/javascript/langgraph/streaming/custom-transformers) covers application-specific projections.
