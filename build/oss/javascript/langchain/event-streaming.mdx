...
See [Custom projections](/oss/javascript/langgraph/streaming/custom-projections) for the transformer contract.

## Related

- [Pregel Streaming](/oss/javascript/langchain/streaming) covers low-level Pregel stream modes.
- [Custom projections](/oss/javascript/langgraph/streaming/custom-projections) covers application-specific projections.
